...
type PostCollectConsumer struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewPostCollectConsumer(ctx context.Context, svcCtx *svc.ServiceContext) *PostCollectConsumer {
	return &PostCollectConsumer{ctx: ctx, svcCtx: svcCtx}
}

func (c *PostCollectConsumer) StartConsume(brokers []string, topic string, group string) error {
	...
	handler := &postCollectConsumerGroupHandler{ctx: c.ctx, svcCtx: c.svcCtx}
	for {
...
type postCollectConsumerGroupHandler struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func (h *postCollectConsumerGroupHandler) Setup(_ sarama.ConsumerGroupSession) error   { return nil }
func (h *postCollectConsumerGroupHandler) Cleanup(_ sarama.ConsumerGroupSession) error { return nil }
func (h *postCollectConsumerGroupHandler) ConsumeClaim(session sarama.ConsumerGroupSession, claim sarama.ConsumerGroupClaim) error {
