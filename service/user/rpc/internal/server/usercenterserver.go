...
func (s *UserCenterServer) RefreshToken(ctx context.Context, in *pb.RefreshTokenReq) (*pb.RefreshTokenResp, error) {
...
func (s *UserCenterServer) BatchGetUserBasicInfo(ctx context.Context, in *pb.BatchGetUserBasicInfoReq) (*pb.BatchGetUserBasicInfoResp, error) {
	l := logic.NewBatchGetUserBasicInfoLogic(ctx, s.svcCtx)
	return l.BatchGetUserBasicInfo(in)
}
