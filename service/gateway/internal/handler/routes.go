...
func RegisterHandlers(server *rest.Server, serverCtx *svc.ServiceContext) {
	server.AddRoutes([]rest.Route{
		...
		{Method: http.MethodGet, Path: "/api/posts/:id/star", Handler: CheckPostStarHandler(serverCtx)},
		...
		{Method: http.MethodGet, Path: "/api/posts/:id/collect", Handler: CheckPostCollectionHandler(serverCtx)},
