...
CREATE TABLE `post` (
                        ...
                        `visibility` TINYINT NOT NULL DEFAULT '0' COMMENT '可见性:0私密,10充电,20粉丝,50互关,90公开',
                        ...
                        `latest_replied_at` DATETIME(3) DEFAULT NULL COMMENT '最后回复时间',
...
CREATE TABLE `post_collection` (
                                   ...
                                   `user_id` BIGINT UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户ID',
                                   `collected_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '收藏时间',
                                   PRIMARY KEY (`id`),
...
CREATE TABLE `post_star` (
                             ...
                             `post_id` BIGINT UNSIGNED NOT NULL DEFAULT '0' COMMENT '动态ID',
                             `user_id` BIGINT UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户ID',
                             `liked_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) COMMENT '点赞时间',
                             PRIMARY KEY (`id`),
                             UNIQUE KEY `uk_user_post` (`user_id`, `post_id`),
                             KEY `idx_post_id` (`post_id`)
...
CREATE TABLE `comment` (
                           `id` BIGINT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '评论ID（单机自增，分布式可替换为雪花ID）',
                           `post_id` BIGINT UNSIGNED NOT NULL COMMENT '动态ID',
                           `user_id` BIGINT UNSIGNED NOT NULL COMMENT '发表用户ID',
                           `parent_id` BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '父评论ID，0表示根评论',
                           `reply_to_user_id` BIGINT UNSIGNED DEFAULT NULL COMMENT '@回复的目标用户ID（冗余）',
...
CREATE TABLE `comment_content` (
                                   ...
                                   `content` MEDIUMTEXT NOT NULL COMMENT '评论内容（文本/图片URL）',
                                   `content_type` TINYINT UNSIGNED NOT NULL DEFAULT 1 COMMENT '内容类型：1纯文本，2图片URL',
                                   `created_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
                                   `updated_at` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3) ON UPDATE CURRENT_TIMESTAMP(3),
                                   PRIMARY KEY (`id`),
